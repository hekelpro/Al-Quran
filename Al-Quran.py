"""
Mau Ngapain Bro?
malu ah program gw jelek jangan diliat ya bro
"""
import requests as r, os
from bs4 import BeautifulSoup as par

os.system('clear')
try: a = r.get('https://litequran.net').text
except r.exceptions.ConnectionError: exit('\x1b[1;91m! \x1b[1;97mTidak Ada Koneksi')
a = par(a,'html.parser')
no = 0
print('''\x1b[1;97m=============================================
...
\x1b[1;97m=============================================''')
print('\n\x1b[1;92m1 \x1b[1;91mKeluar Program')
for x in a.find_all('a'):
	...
	if titel == None:
		...
		print(f'\x1b[1;92m{str(no)} \x1b[1;97m{titel}')
...
try:
	...
	if pil =='1':
		...
		for al in scrap.find_all('span', class_="ayat"):
			ayat += 1
			al = (al.text)
			print(f'\x1b[1;92m{str(ayat)}\x1b[1;97m {al.strip()}')
		print("\x1b[1;97m="*45)
		print("Cara Bacanya: \n")
		for bc in scrap.find_all('span', class_="bacaan"):
			bacaan += 1
			bc = (bc.text)
			print(f'\x1b[1;92m{str(bacaan)} \x1b[1;97m{bc.strip()}')
		print("\x1b[1;97m="*45)
		print("Artinya: \n")
		for ar in scrap.find_all('span', class_="arti"):
			arti += 1
			ar = (ar.text)
			print(f'\x1b[1;92m{str(arti)} \x1b[1;97m{ar.strip()}')
		print("="*45)
except ValueError:
...
# <!-- Kalau Bisa Memakai Kenapa Gak jadi Pembuat? --!>
